...
public class StandardBookService implements BookService {
    ...
    @Override
    public Book createBook(String title, String author, String edition, String isbn, int yearOfPublication, String summary) {
        Book book = new Book(title, author, edition, isbn, yearOfPublication, summary);
